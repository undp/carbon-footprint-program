...
// PostgreSQL admin password (auto-generated by deploy.sh)
// - Leave empty ('') - script generates secure password
// - Stored in Key Vault: postgres-admin-password
// ⚠️ SECURITY: Never commit actual passwords to version control
param dbPassword = ''

// Developer name for resource tagging (set by deploy.sh from DEVELOPER_NAME)
param developerName = ''
