...
if [ "$DRY_RUN" = "true" ]; then
  ...
  echo "  - App Service:     Ready for API deployment"
  ...
  echo ""
  echo "═══════════════════════════════════════════════════════════════"
  echo "📋 NEXT STEPS: Deploy your applications"
  echo "═══════════════════════════════════════════════════════════════"
  echo ""
  echo "The infrastructure is ready. Now deploy your applications:"
  echo ""
  echo "  cd infra"
  echo ""
  echo "  # Deploy API backend:"
  echo "  ./deploy-api.sh"
  echo ""
  ...
  echo ""
  echo "This will:"
  echo "  - Build and deploy your Fastify/Node.js API to App Service"
  echo "  - Build and deploy your React/Vite frontend to Static Web Apps"
  echo "  - Apply any pending database migrations"
  echo ""
  echo "═══════════════════════════════════════════════════════════════"
  echo ""
