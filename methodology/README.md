...
A la fecha del último commit en esta carpeta, las **7 inconsistencias críticas de valor** identificadas en la auditoría profunda están corregidas en el JSON. Los hallazgos estructurales (GWP versionado, ISO 14064 coverage, country-agnosticism, refrigerantes/procesos faltantes, esquema de auditabilidad) **siguen abiertos** — ver sección "Lo que no se modificó" en `methodologies-corrections-report.md`.
