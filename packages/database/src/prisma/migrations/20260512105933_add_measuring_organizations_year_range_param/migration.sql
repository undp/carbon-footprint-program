...
-- Re-declare organization_summary_view so the carbon-inventory year filter reads the
-- window from system_parameter instead of using the hardcoded literal "2".
