...
| **i18n** | *(not implemented)* | — | ❌ Proposal included i18next; not yet adopted |
| **Testing (unit)** | Vitest | — | ⚠️ Configured but no tests written yet |
| **Testing (E2E)** | *(not implemented)* | — | ❌ Proposal included Playwright; not yet adopted |
| **FE monitoring** | *(not implemented)* | — | ❌ Proposal included Azure App Insights JS SDK; not yet adopted |
...
| **Cache** | *(not implemented)* | — | ❌ Proposal included Redis; not yet adopted |
| **Job queues** | *(not implemented)* | — | ❌ Proposal included BullMQ; not yet adopted |
| **Observability** | *(not implemented)* | — | ❌ Proposal included Azure App Insights + OpenTelemetry; not yet adopted |
...
| **Git hooks** | *(not configured)* | ❌ Proposal included Husky + lint-staged; not configured |
...
| Frontend tests | Vitest + RTL + Playwright | Not yet implemented | Risk: no FE regression coverage |
