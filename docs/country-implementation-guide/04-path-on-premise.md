...
| Migrate fails with `type "system_role" already exists`, then P3009 | The database ran the migration history from before its consolidation | One-time [migration history reset](../operations/migration-history-reset.md), then re-apply the grants                                         |
