...
| `CALCULATOR_YEARS_RANGE_FROM_CURRENT`             | [`apps/web/src/config/constants.ts`](../../apps/web/src/config/constants.ts)             | 5                                   | How many past years the maintainer can date a factor for (a UI window only)          |
