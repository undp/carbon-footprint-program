...
Step-by-step guide for a country adopting the platform — written for the national
team (environmental authority, methodology specialists, content and IT), not only
...
| [2. Seed content](./country-implementation-guide/02-seed-content.md)                             | Which seed files to replace, who owns each, critical points, explanation-writing rules   |
...
| [4. Infrastructure](./country-implementation-guide/04-infrastructure.md)                         | Cloud vs on-premise, IT checklist, first-deploy sequence, known field issues             |
| [5. Validation and go-live](./country-implementation-guide/05-validation-and-go-live.md)         | Seed and functional validation, legal obligations, pilot, training, operations           |
