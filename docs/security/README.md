...
| [Chatbot and RAG Security](./chatbot.md)                | Trust boundaries for the AI assistant: tool-argument validation, prompt-injection handling of retrieved content, corpus visibility, conversation identity, and mock-provider guards |
