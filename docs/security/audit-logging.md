...
These fields record *who* made a change and *when*, providing a lightweight audit trail for data modifications. They are set automatically by the application at write time.
