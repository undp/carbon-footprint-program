...
| [Migration History Reset](./migration-history-reset.md)          | One-time reset required by the consolidated migrations: `pnpm db:restore:keep-users` rebuilds the database and keeps the users                                         |
