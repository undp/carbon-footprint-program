...
| [Number Formatting (Web)](./number-formatting.md)    | Which `Formatter` method to use, emission-factor and intensity precision rules, audit tooltips, and display vs input scales                                                                                                              |
