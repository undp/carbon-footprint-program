...
Emisiones generadas durante el **uso** de los productos que tu empresa vende, a lo largo de su **vida útil**, cuando los clientes los utilizan.
...
Corresponde a Alcance 3, Categoría 5 de ISO 14064-1.
...
**CO₂eq = Unidades vendidas × Energía consumida por unidad durante vida útil × Factor de emisión**

**Por unidad vendida:**

> Emisiones por unidad = Consumo anual × Vida útil × Factor de la red

**Total:**

> Emisiones sub-categoría = Unidades vendidas × Emisiones por unidad
...
- Factor referencial de la red eléctrica del país de venta: **0,30 kg CO₂eq/kWh**

Cálculo:

**Por unidad:**

> 350 kWh/año × 15 años × 0,30 kg/kWh = **1.575 kg CO₂eq/unidad**

**Total:**

> 1.200 unidades × 1.575 kg = **1.890.000 kg CO₂eq**

Es decir, los refrigeradores vendidos en el año habrán generado:

- **1.890.000 kg CO₂eq** durante su vida útil
- O lo mismo que **1.890 toneladas de CO₂eq**

> 📊 **Si vendieras los mismos refrigeradores en otro país**, el resultado cambia bastante: con factor 0,25 (Perú) serían 1.575 ton; con 0,35 (Chile) serían 2.205 ton; con 0,55 (RD) serían 3.465 ton. Si exportas a múltiples mercados, calcula por país.

> ⚠️ **Observación:** este número se reporta **en el año de venta**, aunque las emisiones se distribuyan en 15 años de uso.

> ⚠️ **Es importante que las unidades coincidan.** Si el factor está en kg CO₂eq/kWh, la cantidad debe estar en kWh totales.
...
- **Combustibles vendidos:** factor especial. Para 1 L de gasolina vendido, las emisiones son ~2,3 kg CO₂eq (combustión completa).
