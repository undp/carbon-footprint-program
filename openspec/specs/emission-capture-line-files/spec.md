# emission-capture-line-files Specification

## Purpose

Defines the behavior of the per-line file attachment feature on the Emission Capture screen, including upload, preview, deletion, validation, authorization, persistence semantics, and UI affordances.
