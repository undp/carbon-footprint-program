...
- Summary section with count cards per badge type (Diploma Medición, Reconocimiento de Verificación, Reconocimiento de Reducción, Reconocimiento de Neutralización), each card showing a preview of the seal image
