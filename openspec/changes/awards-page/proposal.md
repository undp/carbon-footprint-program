...
- Summary section with count cards per badge type (Diploma Medición, Sello Verificación, Sello Reducción, Sello Neutralización), each card showing a preview of the seal image
