...
import { requestReductionProjectVerificationRoute } from "@/features/reductionProjects/requestReductionProjectVerification/route.js";
...
export default function reductionProjectsRoutes(fastify: FastifyZodInstance) {
  ...
  requestReductionProjectVerificationRoute(fastify);
}
