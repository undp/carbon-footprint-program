          ...
          create: [
            {
              ...
              factorSelection: {
                ...
                totalEmissions: manualTotalEmissions,
              },
          ...
          create: [
            {
              ...
              factorSelection: {
                ...
                emissionFactorId: emissionFactor.id.toString(),
                appliedRateMeasurementUnitId: rateMeasurementUnit.id.toString(),
              },
          ...
          create: [
            {
              ...
              factorSelection: {
                ...
                source: "Otro",
                value: appliedFactorValue,
                rateMeasurementUnitId: rateMeasurementUnit.id.toString(),
              },
