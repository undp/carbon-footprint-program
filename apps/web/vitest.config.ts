...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Low global floor set just below the current level (lines ~5.45%,
      // statements ~5.54%, functions ~3.09%, branches ~5.4% — Wave 1 utils,
      // Wave 2 access-hooks + stores, Wave 3 label/chip mappers, and the
      // getApiErrorMessage tests already on main via #508). This is a
      ...
      // ~98% untested UI. The floor prevents backsliding and should keep being
