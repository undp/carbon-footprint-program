...
export const OrganizationSizesMaintainerScreen: FC = () => {
  ...
  return (
    <ProfilingMaintainerScreenLayout
      ...
      subtitle={`Gestiona los tamaños que ${VOCAB.organization.article.plural} pueden seleccionar. El orden de las filas se respetará al mostrar las opciones en el perfil de ${VOCAB.organization.article.singular}.`}
