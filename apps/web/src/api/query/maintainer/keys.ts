export enum MaintainerQueryKey {
  ...
  SubcategoryRecommendations = "subcategoryRecommendations",
  ...
  SubcategoryRecommendationsUpdateDependency = "maintainerSubcategoryRecommendationsUpdateDependency",
  EmissionFactorsUpdateDependency = "maintainerEmissionFactorsUpdateDependency",
  EmissionFactorDimensionsUpdateDependency = "maintainerEmissionFactorDimensionsUpdateDependency",
